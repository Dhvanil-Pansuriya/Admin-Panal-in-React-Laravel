      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.3 }} // Smooth transition
            onClick={handleModalClick} // Stop event propagation
          >
            ...
            <section>
              ...
              <div className="mb-4">
                ...
                <div className="w-full px-3 py-2 border border-gray-300 rounded-sm bg-gray-100">
                  {user ? formatDate(user.updated_at) : "N/A"}
                </div>
              </div>
              <div className="mb-4">
                <label htmlFor="email_verified_at" className="block text-sm font-medium text-gray-700 mb-1">
                  Email Verified At
                </label>
                <div className="w-full px-3 py-2 border border-gray-300 rounded-sm bg-gray-100">

        ...
        <div className="px-4 py-5 sm:p-6">
          <div className="space-y-8">
            <div>
              ...
              <div className="mt-4 h-96 bg-gray-50 rounded-lg flex items-center justify-center">
                <DummyBarGraph />
              </div>
            </div>
            <div>
                      ...
                      {[
                        ...
                        <tr key={report.name}>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm">
                            <span className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${report.status === 'Completed'
